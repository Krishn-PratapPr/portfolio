...
export default function Intro(){
  ...
  return (
    <section ref={ref} id='home' className='scroll-mt-28 mb-28 xl:max-w-[60rem] max-w-[50rem] text-center sm:mb-0 '>
        ...
        <div className='relative'>
          ...
          >
            <Image 
              ...
              alt='profile'
              priority={true}
              className='h-24 w-24 rounded-full border-[0.32rem] border-white object-cover shadow-xl'
            />
          </motion.div>
          {/* <motion.span 
      ...
      >
        <span className='font-bold'>Krishn Pratap Singh</span>
      ...
      >
        ...
        <a href="/CV.pdf" target="_blank" type="application/pdf" className='group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-105 hover:scale-105 active:scale-105 transition border borderBlack dark:bg-white/10 dark:text-white/60' download>
